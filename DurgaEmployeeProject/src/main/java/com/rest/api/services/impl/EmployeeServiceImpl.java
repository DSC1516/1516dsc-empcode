...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public Optional<Employee> getEmployee(int id) {
		// TODO Auto-generated method stub
		Optional<Employee> emp=Optional.ofNullable(empRepository.findById(id).orElseThrow(()-> new com.rest.api.exception.ResourseNotFoundException("Given employee is is not found")));
		return emp;
	}
	
	public Employee calculateTaxDetails(Employee employee) {
	...
	@Override
	public void calculateTaxDetails(Optional<Employee> employee) {
		// TODO Auto-generated method stub
